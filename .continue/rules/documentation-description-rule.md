...
## globs: docs/\*\*/\*.{md,mdx} description: This rule applies to all documentation files to ensure consistent SEO optimization and improve discoverability. It helps users and search engines understand the content of each page before reading it.
